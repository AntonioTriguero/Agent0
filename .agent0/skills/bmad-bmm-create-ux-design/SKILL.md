...
prompt-reference: .agents/prompts/bmad-bmm-create-ux-design.md
user-invocable: True
metadata:
  prompt-location: .agents/prompts/bmad-bmm-create-ux-design.md
  prompt-size: 320
  prompt-modified: 1770372526.1680338
---
...
- **Original Location:** `.agents/prompts/bmad-bmm-create-ux-design.md`
- **File Size:** 320 bytes
- **Last Modified:** 1770372526.1680338
