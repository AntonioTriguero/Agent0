...
prompt-reference: .agents/prompts/bmad-agent-bmm-quick-flow-solo-dev.md
user-invocable: True
metadata:
  prompt-location: .agents/prompts/bmad-agent-bmm-quick-flow-solo-dev.md
  prompt-size: 648
  prompt-modified: 1770372526.1681862
---
...
- **Original Location:** `.agents/prompts/bmad-agent-bmm-quick-flow-solo-dev.md`
- **File Size:** 648 bytes
- **Last Modified:** 1770372526.1681862
