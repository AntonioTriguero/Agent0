...
prompt-reference: .agents/prompts/bmad-agent-bmm-qa.md
user-invocable: True
metadata:
  prompt-location: .agents/prompts/bmad-agent-bmm-qa.md
  prompt-size: 597
  prompt-modified: 1770372526.1731935
---
...
- **Original Location:** `.agents/prompts/bmad-agent-bmm-qa.md`
- **File Size:** 597 bytes
- **Last Modified:** 1770372526.1731935
