...
prompt-reference: .agents/prompts/bmad-agent-bmm-sm.md
user-invocable: True
metadata:
  prompt-location: .agents/prompts/bmad-agent-bmm-sm.md
  prompt-size: 597
  prompt-modified: 1770372526.1682055
---
...
- **Original Location:** `.agents/prompts/bmad-agent-bmm-sm.md`
- **File Size:** 597 bytes
- **Last Modified:** 1770372526.1682055
