...
prompt-reference: .agents/prompts/bmad-agent-bmm-dev.md
user-invocable: True
metadata:
  prompt-location: .agents/prompts/bmad-agent-bmm-dev.md
  prompt-size: 600
  prompt-modified: 1770372526.1680768
---
...
- **Original Location:** `.agents/prompts/bmad-agent-bmm-dev.md`
- **File Size:** 600 bytes
- **Last Modified:** 1770372526.1680768
