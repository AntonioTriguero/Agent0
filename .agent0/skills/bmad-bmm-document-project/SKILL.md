...
prompt-reference: .agents/prompts/bmad-bmm-document-project.md
user-invocable: True
metadata:
  prompt-location: .agents/prompts/bmad-bmm-document-project.md
  prompt-size: 913
  prompt-modified: 1770372526.1680596
---
...
- **Original Location:** `.agents/prompts/bmad-bmm-document-project.md`
- **File Size:** 913 bytes
- **Last Modified:** 1770372526.1680596
