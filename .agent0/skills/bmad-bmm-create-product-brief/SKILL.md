...
prompt-reference: .agents/prompts/bmad-bmm-create-product-brief.md
user-invocable: True
metadata:
  prompt-location: .agents/prompts/bmad-bmm-create-product-brief.md
  prompt-size: 372
  prompt-modified: 1770372526.1679814
---
...
- **Original Location:** `.agents/prompts/bmad-bmm-create-product-brief.md`
- **File Size:** 372 bytes
- **Last Modified:** 1770372526.1679814
