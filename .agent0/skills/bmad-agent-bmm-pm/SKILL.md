...
prompt-reference: .agents/prompts/bmad-agent-bmm-pm.md
user-invocable: True
metadata:
  prompt-location: .agents/prompts/bmad-agent-bmm-pm.md
  prompt-size: 597
  prompt-modified: 1770372526.1680481
---
...
- **Original Location:** `.agents/prompts/bmad-agent-bmm-pm.md`
- **File Size:** 597 bytes
- **Last Modified:** 1770372526.1680481
