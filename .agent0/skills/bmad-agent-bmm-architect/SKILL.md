...
prompt-reference: .agents/prompts/bmad-agent-bmm-architect.md
user-invocable: True
metadata:
  prompt-location: .agents/prompts/bmad-agent-bmm-architect.md
  prompt-size: 618
  prompt-modified: 1770372526.1679692
---
...
- **Original Location:** `.agents/prompts/bmad-agent-bmm-architect.md`
- **File Size:** 618 bytes
- **Last Modified:** 1770372526.1679692
