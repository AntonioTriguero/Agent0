...
prompt-reference: .agents/prompts/bmad-bmm-create-prd.md
user-invocable: True
metadata:
  prompt-location: .agents/prompts/bmad-bmm-create-prd.md
  prompt-size: 885
  prompt-modified: 1770372526.1681464
---
...
- **Original Location:** `.agents/prompts/bmad-bmm-create-prd.md`
- **File Size:** 885 bytes
- **Last Modified:** 1770372526.1681464
